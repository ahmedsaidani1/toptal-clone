...
const CategoryCard = ({icons,title}) => {
  return (
    <div className='category-card dark:text-white md:p-4 p-2 shadow-lg rounded-md flex items-center gap-4 justify-between border border-transparent hover:border-[#20B486] hover:cursor-pointer group/edit'>
